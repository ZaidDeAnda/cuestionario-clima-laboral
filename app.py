...
if check_password():
    ...
    st.write("Favor de responder a la siguiente encuesta moviendo el slider a la posición que mejor refleje tu opinión al respecto.")
    ...
    with st.form("formulario"):
        ...
        form_dict["igualdad_4"] = st.select_slider("", ["Siempre", "A veces", "Nunca"], key="igualdad_4", value="A veces", label_visibility="collapsed")
        ...
        form_dict["igualdad_5"] = st.select_slider("", ["Siempre", "A veces", "Nunca"], key="igualdad_5", value="A veces", label_visibility="collapsed")
        ...
        form_dict["igualdad_6"] = st.select_slider("", ["Siempre", "A veces", "Nunca"], key="igualdad_6", value="A veces", label_visibility="collapsed")
        ...
        form_dict["igualdad_7"] = st.select_slider("", ["Siempre", "A veces", "Nunca"], key="igualdad_7", value="A veces", label_visibility="collapsed")
        ...
        form_dict["igualdad_8"] = st.select_slider("", ["Siempre", "A veces", "Nunca"], key="igualdad_8", value="A veces", label_visibility="collapsed")
